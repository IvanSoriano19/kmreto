    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 flex flex-col items-center justify-center px-6 transition-colors">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-semibold text-gray-900 dark:text-white">KmReto</h1>
          <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">El reto familiar de kilómetros</p>
        </div>

        <button
          onClick={handleGoogle}
          className="w-full flex items-center justify-center gap-2 border border-gray-200 dark:border-gray-700 rounded-xl py-3 text-sm font-medium text-gray-700 dark:text-gray-300 mb-4 hover:bg-gray-50 dark:hover:bg-gray-800"
        >
        ...
        <p className="text-center text-xs text-gray-400 dark:text-gray-500 mt-6">
          ¿No tienes cuenta?{' '}
          <button onClick={() => navigate('/register')} className="text-green-600 font-medium">
            Crear cuenta
          </button>
        </p>
      </div>
